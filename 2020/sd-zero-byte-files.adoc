...
:tags: en
:date: 2020-11-12T11:55:48+01:00
...
You can see the code change in https://gerrit.libreoffice.org/c/core/+/104939[this commit]. First,
we restrict this trick to file URLs, and also to empty files.
