...
As link:/blog/s40-apps-i-use[this post] already suggested, about a week ago I
replaced link:/blog/3110c[my S40] with $title. (Yes, I know that S II is
...
- https://github.com/vmiklos/vmexam/blob/master/gammu/gammu2gcontacts[gammu2gcontacts] to extract contacts from the gammu backup (link:/blog/gammu2gcontacts[earlier post])
